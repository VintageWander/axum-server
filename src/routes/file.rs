...
pub fn get_files_route() -> Router<SharedState> {
    Router::new().route("/", get(get_files_handler))
}

pub fn file_content_route() -> Router<SharedState> {
    Router::new().route("/:file_id", get(file_content_handler))
}

pub fn get_file_versions_route() -> Router<SharedState> {
...
pub fn update_file_route() -> Router<SharedState> {
    Router::new().route("/:file_id", put(update_file_handler))
}

pub fn restore_file_route() -> Router<SharedState> {
    Router::new().route("/restore", put(restore_file_handler))
}

pub fn delete_file_route() -> Router<SharedState> {
